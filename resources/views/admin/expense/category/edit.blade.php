              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="hidden" name="id" value="{{$data->expcat_id}}"/>
                        <input type="text" class="form-control form_control" id="" name="name" value="{{$data->expcat_name}}">
                        @if($errors->has('name'))
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-7">
                        <textarea class="form-control form_control" id="" name="remarks">{{$data->expcat_remarks}}</textarea>
                      </div>
                    </div>
                </div>
