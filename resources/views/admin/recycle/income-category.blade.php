      ...
      <div class="row">
                  ...
                  <table class="table table-bordered table-striped table-hover custom_table">
                    ...
                    <tr>
                      ...
                      <td> <a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->incate_id}}"><i class="fas fa-recycle fs-4 text-success fw-bold mx-1"></i></a>
                          
                      <a href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->incate_id}}"><i class="fas fa-trash fs-4 text-danger fw-bold"></i></a>
                      </td>
...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{url('dashboard/income/category/restore')}}" method="post">
      @csrf
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{url('dashboard/income/category/delete')}}" method="post">
      @csrf
      <div class="modal-content modal_content">
        <div class="modal-header modal_header">
