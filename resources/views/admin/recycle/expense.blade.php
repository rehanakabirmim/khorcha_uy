              ...
              <table id="alltableinfo" class="table table-bordered table-striped table-hover custom_table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$data->categoryInfo->expcat_name}}</td>
                    <td>{{number_format($data->expense_amount,2)}}</td>
                    <td>
                      <a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->expense_id}}"><i class="fas fa-recycle fs-5 text-success fw-bold mx-1"></i></a>
